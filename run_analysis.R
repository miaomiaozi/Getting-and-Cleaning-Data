...
write.table(groupData, "./Getting and Cleaning Data Project/MeanData.txt", row.names = FALSE)
write.table(finalData, "./Getting and Cleaning Data Project/MergedData.txt", row.names = FALSE)
